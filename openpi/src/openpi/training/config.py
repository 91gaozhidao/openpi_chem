...
class TrainConfig:
    ...
    save_interval: int = 41523
    # If set, any existing checkpoints matching step % keep_period == 0 will not be deleted.
    keep_period: int | None = 41523
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=ChemDataConfig(
            ...
            assets=AssetsConfig(
                # asset_id="chem",
                assets_dir="/data/workspace/zhangxin/openpi/pretrained/pi05_base/assets",
            ),
            adapt_to_pi=False,
            base_config=DataConfig(
                prompt_from_task=True,
        ...
        # # warmup的步数设置为10%的总训练步数，decay_steps设置为70%的总训练步数
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader("/data/workspace/zhangxin/openpi/pretrained/pi05_base/params"),
